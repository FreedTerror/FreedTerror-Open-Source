...
public class DefaultUFEScreenScrollRect : UFEScreen{
    ...
    public override void DoFixedUpdate(
        ...
        if (UFE2FTE.UFE2FTEPlayerPausedOptionsManager.playerPaused == UFE2FTE.UFE2FTEPlayerPausedOptionsManager.Player.Player1)
        {
        ...
        else if (UFE2FTE.UFE2FTEPlayerPausedOptionsManager.playerPaused == UFE2FTE.UFE2FTEPlayerPausedOptionsManager.Player.Player2)
        {

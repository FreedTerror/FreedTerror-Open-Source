...
namespace FreedTerror.UFE2
{
    ...
    {        
        ...
        private void SetDefaultMoveInfoOptions(UFE3D.CharacterInfo characterInfo)
        {
            ...
            CharacterSpecificMoveInfoScriptableObject characterSpecificMoveInfoScriptableObject = UFE2Manager.instance.characterInfoReferencesScriptableObject.GetCharacterSpecificMoveInfoScriptableObject(characterInfo);

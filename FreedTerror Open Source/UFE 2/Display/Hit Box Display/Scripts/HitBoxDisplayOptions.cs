...
{
    [System.Serializable]
    public class HitBoxDisplayOptions
    {
        public UFE2Manager.HitBoxDisplayMode hitBoxDisplayMode = UFE2Manager.HitBoxDisplayMode.Off;
        [Range(0, 255)]
        ...
        [Tooltip("The amount of lines Popcron Gizmos have.")]
        [Range(0, 100)]

...
namespace UFE2FTE
{
    public class CharacterAlertController : MonoBehaviour
    {
        ...
        public CharacterData GetCharacterData(UFE2FTE.Player player)
        {
            if (player == UFE2FTE.Player.Player1)
            {
                return player1CharacterData;
            }
            else if (player == UFE2FTE.Player.Player2)
            {
        ...
        private void Update()
        {
            CharacterData.SetCharacterData(UFE.GetPlayer1ControlsScript(), player1CharacterData, player2CharacterData, characterDataOverrideOptions);
            CharacterData.SetCharacterData(UFE.GetPlayer2ControlsScript(), player2CharacterData, player1CharacterData, characterDataOverrideOptions);
